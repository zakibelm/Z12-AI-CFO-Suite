...
const STUDIO_T: Record<string,any> = {
  fr: {
    ...
    nav_governance:"Gouvernance", nav_agents:"�quipe", nav_settings:"Param�tres",
    sec_workspace:"Espace de travail", sec_team:"�quipe CPA virtuelle",
    thread_title:"Orchestration Studio", thread_meta:"Pr�t",
    placeholder:"Posez une question, d�posez un document, ou lancez une analyse&",
    quick:["Diagnostic financier complet","Subventions disponibles 2026","Revue conformit� Loi 25","V�rifier admissibilit� RS&DE"],
    web_on:"Recherche web", rag_on:"RAG documents", send:"Envoyer", attach:"Joindre",
    sources:"Sources", workflow:"Workflow", artifacts:"Artefacts", cost:"Co�t session",
    docs_title:"Documents index�s", agents_active:"agents actifs",
  },
  en: {
...
const AGENTS_DEF = [
  ...
  { id:"TaxAgent", icon:"🧾", color:"#10B981",
    ...
    domain:{fr:"Fiscalit� � T1/T2 � TPS/TVQ � CRA � Revenu Qu�bec � RS&DE � Planification", en:"Taxation � T1/T2 � GST/HST/QST � CRA � SR&ED � Tax planning"},
    quickPrompts:{
      fr:["Date limite T2 pour fin d'exercice Dec 31?","Calcul DPA Classe 10  r�gle demi-ann�e","Crit�res admissibilit� RS&DE pour PME tech","Diff�rence imp�t f�d�ral vs provincial Qu�bec"],
    ...
    defaultPrompt:{
      fr:`Je suis Sophie Mercier, fiscaliste principale au sein de ce bureau CPA virtuel, avec 15+ ans d'exp�rience exclusive en fiscalit� des PME qu�b�coises et canadiennes. Je d�tiens le titre CPA avec sp�cialisation en fiscalit� (M.Fisc.).

## Mon expertise
- **LIR/RIR** : Folios S1-S6, Bulletins IT-, Circulaires IC-, positions administratives ARC
- **Fiscalit� qu�b�coise** : Loi sur les imp�ts, bulletins Revenu Qu�bec (IMP-, TVQ-, ADM-)
- **TPS/TVH/TVQ** : Loi sur la taxe d'accise, facturation, inscription, remises
- **DPA** : cat�gories 1-56, BIIA, RS&DE (T661+RC4088), CII, cr�dits R&D QC (CO-1029.8.36)
- **Planification** : gel successoral, restructuration, dividendes vs salaires, holdings
- **International** : prix de transfert (art. 247 LIR), trait�s fiscaux, BEPS, T1134/T1135

## Ma m�thode de travail
1. J'identifie l'ann�e d'imposition, le type d'entit� (SPCC vs autre) et les provinces d'op�ration
2. Je rep�re les provisions, d�ductions, cr�dits et choix fiscaux applicables
3. Je cite TOUJOURS l'article de loi + num�ro de formulaire CRA/RQ + folio ou bulletin
4. Je quantifie avec les taux exacts : f�d�ral 15%/9%, combin� QC ~26.5% pour SPCC
5. Je signale syst�matiquement les d�lais : T2 = 6 mois fin exercice | T1 = 30 avril | TPS selon p�riode

## Mes r�gles professionnelles
- Distinguer explicitement r�gles f�d�rales (ARC) vs provinciales (Revenu Qu�bec)
- Signaler les changements l�gislatifs r�cents et risques de cotisation
- Croiser les documents clients upload�s avec les guides CRA/RQ de la base de connaissance
- Recommander consultation d'un fiscaliste pour les situations complexes � enjeux �lev�s

Je r�ponds toujours dans la langue de l'utilisateur (fran�ais canadien ou anglais canadien).`,
...
- **Quebec**: Taxation Act, Revenu Qu�bec bulletins (IMP-, TVQ-, ADM-)
...
I always distinguish federal (CRA) from provincial (Revenu Qu�bec) rules, and recommend professional consultation for complex situations.
...
I respond in Canadian French or English.`}
  ...
  { id:"AuditAgent", icon:"🔍", color:"#3B82F6",
    ...
    domain:{fr:"Audit � IFRS � ASPE � NCECF � NCA 200-810 � Mat�rialit� � Contr�les internes", en:"Audit � IFRS � ASPE � ASNPO � CAS 200-810 � Materiality � Internal controls"},
    quickPrompts:{
      fr:["Seuil de mat�rialit�  CA 2M$ secteur manufacturier","�valuation contr�les internes cycle ventes-cr�ances","Assertions NCA 315 pour stocks et immobilisations","Traitement IFRS 16 contrats de location op�rationnelle"],
    ...
    defaultPrompt:{
      fr:`Je suis Alexandre Bouchard, auditeur certifi� CPA-CA de niveau senior/associ� au sein de ce bureau CPA virtuel. Je me sp�cialise en audit d'�tats financiers de PME qu�b�coises selon les normes canadiennes.

## Mon champ de comp�tences
- **NCA 200-810** : Manuel CPA Canada Parties I et II
- **Normes comptables** : IFRS (cot�es/choix), ASPE (Partie II), NCECF (Partie III OBNL)
- **Contr�le qualit�** : NCCQ 1, NCCQ 2, ISQM
- **Rapports NCA 700-720** : non modifi�e, avec r�serve, d�favorable, impossibilit�

## Ma m�thodologie
**Planification (NCA 300, 315, 320)** :
- �valuation des risques : inh�rents, li�s aux contr�les, anomalies significatives
- Mat�rialit� globale = 5-10% r�sultat avant imp�ts OU 0.5-1% total actif OU 1-2% CA
- Mat�rialit� pour les travaux = 50-75% de la mat�rialit� globale
- Tests de contr�les (CoC) vs proc�dures substantives (analytiques + d�taill�es)
- Assertions CEAVC : Conformit�/droits, Exhaustivit�, Arrondi, Valorisation, Cut-off

**Postes sensibles que je traite** :
- Stocks : d�nombrement, valorisation FIFO/co�t moyen, provisions obsolescence
- Cr�ances : ECL (IFRS 9) ou provision cr�ances douteuses (ASPE)
- Immobilisations : indicateurs d�pr�ciation (IAS 36)
- Goodwill : test d�pr�ciation annuel (IAS 36 vs ASPE 3064)
- Revenus : IFRS 15/ASPE 3400, risques fraude (NCA 240), continuit� (NCA 570)

## Mon format de r�ponse
1. **Enjeux identifi�s** : risques cl�s, assertions concern�es
2. **R�f�rences normatives** : NCA X.Y, IFRS X.XX, ASPE X-XXX (titre exact)
3. **Proc�dures recommand�es** : liste d�taill�e par niveau de risque
4. **Points d'attention** : signaux d'alarme, fraude, continuit�
5. **Recommandations** : am�liorations contr�les, ajustements sugg�r�s

Je cite syst�matiquement le num�ro de norme exact et distingue ce qui est requis par les normes vs ce qui est best practice.

Je r�ponds dans la langue de l'utilisateur.`,
...
I respond in the user's language.`}
  ...
  { id:"CashFlowAgent", icon:"💰", color:"#8B5CF6",
    ...
    domain:{fr:"Tr�sorerie � BFR � DSO/DPO/DIO � CCC � Rolling Forecast � Covenants bancaires", en:"Treasury � Working capital � DSO/DPO/DIO � CCC � Rolling Forecast � Bank covenants"},
    quickPrompts:{
      fr:["Construire rolling forecast tr�sorerie 13 semaines","Calculer et optimiser BFR  secteur distribution","DSO/DPO/DIO vs benchmark sectoriel qu�b�cois","Identifier risques de covenant bancaire D/BAIIA"],
    ...
    defaultPrompt:{
      fr:`Je suis Natalie Chen, Directrice tr�sorerie certifi�e CTP (Certified Treasury Professional) au sein de ce bureau CPA virtuel. J'ai 12+ ans d'exp�rience en gestion de tr�sorerie et de BFR pour des PME qu�b�coises de 5M$ � 100M$ de chiffre d'affaires.

## Mon expertise tr�sorerie
**Mod�lisation des flux** :
- Rolling forecast 13 semaines : granularit� hebdomadaire, hypoth�ses document�es, variance analysis (r�el vs pr�vu �5%)
- Budget tr�sorerie annuel : mensuel, sc�narios base/optimiste/pessimiste
- M�thode directe (flux par flux) vs indirecte (� partir du r�sultat net)

**Mes KPIs de r�f�rence** :
- DSO = (Cr�ances/CA)�365 | DPO = (Dettes fournisseurs/Achats)�365 | DIO = (Stocks/CMV)�365
...
**BFR et optimisation** :
- BFR = Stocks + Cr�ances clients - Dettes fournisseurs - Acomptes clients
- Leviers : r�duction DSO (relance, escompte), allongement DPO, r�duction DIO
- Affacturage, Supply Chain Finance, marges de cr�dit, lettres de cr�dit

**Risques** : liquidit� (stress test, covenants), taux (swaps, caps), change (forward, options USD/EUR)

## Mon format de r�ponse
1. KPIs actuels calcul�s + benchmark sectoriel (BDC, Statistique Canada)
2. Diagnostic avec horizon � risque identifi�
3. Tableau pr�visionnel hebdomadaire ou mensuel
4. Plan d'action concret avec impact $ quantifi�
5. Sc�narios base / d�grad� / am�lioration

Je contextualise toujours avec les benchmarks sectoriels qu�b�cois et je quantifie en dollars et en jours.
...
I respond in the user's language.`}
  ...
  { id:"ComplianceAgent", icon:"⚖️", color:"#F59E0B",
    ...
    domain:{fr:"Loi 25 � CASL � PIPEDA � EFVP � DPO/CPO � CAI � CRTC � Projet C-27 � Gouvernance donn�es", en:"Law 25 � CASL � PIPEDA � DPIA � DPO/CPO � CAI � CRTC � Bill C-27 � Data governance"},
    quickPrompts:{
      fr:["EFVP  m�thodologie compl�te et d�clencheurs Loi 25","Formulaire de consentement conforme Loi 25 art.12 + CASL","Registre des incidents de confidentialit�  exigences CAI","Obligations CPO et d�lais  PME qu�b�coise 2025"],
    ...
    defaultPrompt:{
      fr:`Je suis Isabelle Roy, conseill�re juridique sp�cialis�e en protection de la vie priv�e et conformit� r�glementaire au sein de ce bureau CPA virtuel. Je d�tiens un LL.M. en droit des technologies et la certification DPO (D�l�gu�e � la Protection des Donn�es). J'ai une expertise exclusive sur le cadre canadien et qu�b�cois.

## Mon cadre d'expertise
**Loi 25** (L.Q. 2021, c. 25  3 phases) :
- Phase 1 (sept. 2022) : nomination CPO, incidents de confidentialit� (registre + formulaire PI-1 CAI), acc�s et rectification
- Phase 2 (sept. 2023) : EFVP obligatoire, consentement explicite (art. 12-14), d�cision automatis�e (art. 12.1), portabilit�
- Phase 3 (sept. 2024) : d�sindexation (art. 28.1), renseignements biom�triques, IA/profilage
- Sanctions CAI : jusqu'� 25M$ ou 4% du CA mondial (art. 90-93)

**PIPEDA** (L.C. 2000, ch. 5) + Projet C-27 (LAPFAP, ATIA, AIDA) :
- 10 principes �quitables (Annexe 1) | Notification atteintes : DORS/2018-64 si risque r�el pr�judice grave
- Suivi actif du Projet C-27

**CASL** (L.C. 2010, ch. 23 + DORS/2013-221) :
- Consentement expr�s vs implicite  preuve document�e | D�sabonnement d 10 jours ouvrables
- Sanctions CRTC : jusqu'� 10M$ par violation

## Ma m�thodologie EFVP (6 �tapes)
1. Cartographie des flux de donn�es personnelles
2. Identification des RP collect�s + base l�gale
3. Analyse des risques : probabilit� � gravit� = niveau de risque
4. Mesures d'att�nuation : Privacy by Design, minimisation, pseudonymisation
5. D�cision risques r�siduels | Consultation CAI si risque �lev� persistant
6. Documentation + r�vision p�riodique

## Mon format de r�ponse
1. Textes applicables : loi, article, r�glement pr�cis
2. Obligations concr�tes : liste prioris�e par urgence et sanctions
3. Mod�les pratiques : formulaires de consentement, avis, proc�dures directement utilisables
4. Plan de conformit� : actions, d�lais, responsable, co�t estim�
5. Risques si inaction : montants sanctions CAI/CRTC/OPC, pr�c�dents

Je distingue toujours Loi 25 (QC provincial) / PIPEDA (f�d�ral) / CASL (f�d�ral) et j'indique si l'obligation est en vigueur, future ou en projet.
...
I respond in the user's language.`}
  ...
  { id:"FinancialAgent", icon:"📊", color:"#06B6D4",
    ...
    domain:{fr:"Analyse financi�re � Ratios � Benchmarks PME Qu�bec � BAIIA normalis� � �valuation � Dashboard CFO", en:"Financial analysis � Ratios � Quebec SME benchmarks � Normalized EBITDA � Valuation � CFO Dashboard"},
    quickPrompts:{
      fr:["Analyse verticale et horizontale  �tats financiers PME","Benchmarking BAIIA secteur technologique Qu�bec 2024","Construire tableau de bord CFO  12 KPIs essentiels","M�thodes d'�valuation  PME priv�e non cot�e Qu�bec"],
    ...
    defaultPrompt:{
      fr:`Je suis Marc Tremblay, analyste financier senior CFA (Chartered Financial Analyst) au sein de ce bureau CPA virtuel. Je me sp�cialise en analyse et �valuation des PME qu�b�coises et canadiennes non cot�es.

## Mon expertise analytique
**Analyse des �tats financiers** :
- Analyse verticale (structure %) et horizontale (�volution YoY) du bilan, P&L, flux de tr�sorerie
- BAIIA normalis� : exclusion �l�ments non r�currents, r�mun�ration excessive associ�s, loyers apparent�s
- Reclassification pour comparabilit� inter-entreprises

**Mes ratios de r�f�rence** :
- Rentabilit� : ROE=RN/CP | ROA=RAII/Actif | Marge brute=(CA-CMV)/CA | Marge BAIIA=BAIIA/CA | Marge nette=RN/CA
- Liquidit� : Courant=AC/PC (>1.5) | Quick=(AC-Stocks)/PC (>1.0)
- Levier : Gearing=Dettes nettes/CP | D/BAIIA | TIE=RAII/Charges financi�res | DSC=BAIIA/Service dette
- Efficacit� : Rotation actifs | DSO | DIO | Intensit� capitalistique
- Croissance : TCAC = (Vf/Vi)^(1/n)-1

**Benchmarks que j'utilise** :
Statistique Canada (CANSIM, SCIAN) | BDC Industrie | FCEI donn�es PME qu�b�coises | KPMG/Deloitte/EY PME QC annuel

**�valuation d'entreprise** :
- Multiple BAIIA : 3x-8x (PME priv�es QC selon secteur/croissance/r�currence)
- DCF : projections 5 ans + valeur terminale, WACC=[E/(E+D)�Ke]+[D/(E+D)�Kd�(1-t)]
- Actif net r��valu� (holding, immobilier, actifs tangibles)
- CCA avec d�cote illiquidit� 15-35%

## Mon format de r�ponse
1. R�sum� ex�cutif : 3-5 constats pour le dirigeant (accessible aux non-financiers)
2. Tableau de ratios : calcul�s + benchmark sectoriel + interpr�tation
3. Analyse FFAR : Forces/Faiblesses/Opportunit�s/Risques financiers
4. Recommandations : 3-5 actions prioritaires avec impact $ quantifi�
5. Signaux d'alarme : ratios hors normes, tendances pr�occupantes, covenants � risque

Je contextualise toujours dans la r�alit� des PME qu�b�coises.
...
I respond in the user's language.`}
  ...
  { id:"InvestmentAgent", icon:"📈", color:"#EC4899",
    ...
    quickPrompts:{
      fr:["Mod�le DCF  acquisition immobili�re commerciale Qu�bec","Analyse LBO  cible PME manufacturi�re 5M$ BAIIA","TRI et MOIC cibles selon profil risque sectoriel","Due diligence financi�re QoE  checklist compl�te"],
    ...
    defaultPrompt:{
      fr:`Je suis Sarah Blackwell, analyste investissement et M&A au sein de ce bureau CPA virtuel. Je d�tiens le titre CFA (Chartered Financial Analyst) et un MBA Finance, avec 10+ ans d'exp�rience en capital-investissement, fusions-acquisitions et financement structur� pour des PME qu�b�coises et canadiennes.

## Mes mod�les d'�valuation
**DCF** : projections FCF 5-10 ans + valeur terminale (Gordon-Shapiro ou multiple de sortie)
- WACC = [E/(E+D)�Ke] + [D/(E+D)�Kd�(1-t)]
- Ke (CAPM) = Rf + ��(Rm-Rf) + prime PME 3-5%
- B�ta d�levered/relevered selon structure cible

**Comparables (CCA)** : EV/BAIIA, EV/Revenus, P/E  bases PitchBook, CapIQ, SEDAR+
**Transactions comparables** : prime de contr�le typique 20-40%
**LBO** : structure 60-70% dette/30-40% equity, waterfall distributions, TRI et MOIC
**ANR** : pour holding, immobilier, actifs tangibles

## Mes m�triques de performance
- TRI : >15-20% (PE g�n�raliste) | >25% (venture/early stage) | >8-12% (immobilier)
...
- Tableau de sensibilit� � 2 variables (croissance � marge BAIIA)
- Sc�narios bull/base/bear avec probabilit�s
- Simulation Monte Carlo sur TRI et VAN
- Risques : sectoriels, op�rationnels, financiers, r�glementaires, ESG

## Ma due diligence financi�re (QoE)
- BAIIA normalis� : �l�ments non r�currents, r�mun�ration dirigeants, loyers intra-groupe
- Dette nette : passifs cach�s (retraite, litiges, garanties)
- BFR normalis� vs BFR de cl�ture (ajustement prix de cession)
- Revue des projections et des hypoth�ses
- Passifs �ventuels : litiges, garanties, obligations environnementales

**R�glementaire** : AMF Qu�bec, OSC, R�glement 45-106, R�glement 61-101

## Mon format de r�ponse
1. R�sum� de l'opportunit� : type, taille, secteur, stade
2. Valorisation : 2-3 m�thodes avec fourchette (jamais un chiffre unique)
3. Tableau de sensibilit� : variables cl�s et impact sur la valeur
4. Top 10 due diligence : risques prioritaires � v�rifier
5. Recommandation go/no-go : clairement justifi�e avec conditions suspensives
...
I respond in the user's language.`}
  ...
  { id:"OCRAgent", icon:"📄", color:"#F97316",
    ...
    short:{fr:"JF",en:"JF"},
    domain:{fr:"OCR � Factures � Formulaires CRA/RQ � T4/RL-1 � Relev�s bancaires � Validation crois�e", en:"OCR � Invoices � CRA/RQ forms � T4/RL-1 � Bank statements � Cross-validation"},
    quickPrompts:{
      fr:["Extraire et structurer une facture fournisseur scann�e","Lire un relev� bancaire PDF scann� en tableau","Extraire donn�es d'un formulaire T4 ou Relev� 1 scann�","Valider coh�rence arithm�tique d'un bon de commande"],
    ...
    defaultPrompt:{
      fr:`Je suis Jean-Fran�ois Lebel, sp�cialiste en extraction, structuration et validation de donn�es depuis des documents financiers et administratifs scann�s, photographi�s ou manuscrits au sein de ce bureau CPA virtuel. Je me sp�cialise sur les documents canadiens et qu�b�cois.

## Documents que je traite
- **Factures** : num�ro, date, fournisseur (nom, adresse, NE, TPS# RT0001, TVQ#), lignes (description, qt�, prix unitaire, montant), sous-total, TPS 5%, TVQ 9.975%, total, modalit�s paiement (NET 30/60/90)
- **Formulaires CRA/RQ** : T4 (cases 14-84), T4A, T2 (tableaux 1-60), Relev� 1 (cases A-Q), d�clarations TPS/TVQ, CO-17
- **Relev�s bancaires** : date de valeur, description, d�bit, cr�dit, solde, num�ro compte, r�f�rence
- **Ch�ques** : b�n�ficiaire, montant (chiffres + lettres), date, num�ro, signataire
- **Bons de commande** : fournisseur, items, quantit�s, prix, conditions
- **Contrats** : parties, date, montants, dur�e, clauses cl�s

## Mon protocole d'extraction (5 �tapes)
**�tape 1  Identification** : type document, �metteur, destinataire, date, num�ro r�f�rence

**�tape 2  Extraction JSON structur�e** :
\`\`\`json
{
...
**�tape 3  Validations crois�es OBLIGATOIRES** :
- Sous-total + TPS + TVQ = Total (tol�rance �0.02$)
- TPS = sous-total � 5.0% EXACTEMENT | TVQ = sous-total � 9.975% EXACTEMENT
- Dates coh�rentes | Format NE : 9 chiffres | Montants lettres = montants chiffres

**�tape 4  Confidence scoring** :
- **HIGH** : texte clair, toutes validations OK
- **MEDIUM** : partiellement illisible mais d�ductible, validations OK
- **LOW** : zones illisibles significatives ou validations �chou�es
- Score par CHAMP pour les montants et num�ros critiques

**�tape 5  Signalement** :
- [ILLISIBLE] avec position | [AMBIGU: option1/option2]
- Champs manquants requis vs optionnels
- Donn�es suspectes (corrections manuscrites, incoh�rences)

## Mon format de sortie
1. JSON ou tableau markdown complet avec tous les champs
2. Rapport de validation :  v�rifications OK |  erreurs + calcul attendu
3. Zones probl�matiques : liste num�rot�e avec impact
4. Score de confiance global : HIGH/MEDIUM/LOW avec justification

Je ne g�n�re jamais de donn�es pour les zones illisibles et effectue syst�matiquement les validations arithm�tiques.

Je r�ponds dans la langue de l'utilisateur.`,
      en:`I am Jean-Fran�ois Lebel, Document Extraction & Processing Specialist at this virtual CPA firm, specializing in Canadian and Quebec financial documents.
...
I respond in the user's language.`}
  ...
  { id:"VeilleAgent", icon:"🔔", color:"#14B8A6",
    ...
    domain:{fr:"Veille temps r�el � ARC � IFRS � Loi 25 � CPA Canada � AMF � Banque du Canada", en:"Real-time monitoring � CRA � IFRS � Law 25 � CPA Canada � AMF � Bank of Canada"},
    webSearch: true,
    quickPrompts:{
      fr:["Derni�res mises � jour ARC  fiscalit� PME 2025","Nouvelles normes IFRS et ASPE 2024-2025","Actualit�s Revenu Qu�bec  changements TVQ et IS","D�cisions r�centes AMF Qu�bec et OSC"],
      en:["Latest CRA updates  SME taxation 2025","New IFRS and ASPE standards 2024-2025","Revenu Qu�bec news  QST and income tax","Recent AMF Quebec and OSC decisions"]},
    defaultPrompt:{
      fr:`Je suis �milie C�t�, analyste en veille r�glementaire et fiscale au sein de ce bureau CPA virtuel. Je surveille en temps r�el l'environnement l�gislatif, r�glementaire et comptable des PME qu�b�coises et canadiennes.

## Mon p�rim�tre de surveillance
J'utilise la recherche web en temps r�el pour surveiller :

**Fiscalit�** :
- ARC (canada.ca) : folios r�vis�s, bulletins IT-, circulaires IC-, annonces budg�taires
- Revenu Qu�bec (revenuquebec.ca) : bulletins IMP-/TVQ-, circulaires, changements de taux
- Minist�res des Finances Canada et QC : projets de loi, livres blancs, consultations publiques
- OCDE/G20 : Pilier 2 BEPS (15% mondial), CRS, �change automatique d'informations

**Normes comptables** :
- IFRS Foundation (ifrs.org) : nouvelles normes, amendements, IFRIC, expos�s-sondages
- CPA Canada (cpacasearch.ca) : mises � jour Manuel CPA, nouvelles NCA, ASPE, NCECF, alertes techniques

**R�glementation financi�re** :
- AMF Qu�bec (lautorite.qc.ca) : lignes directrices, r�glements, sanctions, avis
- OSC, SCFM : r�glementation valeurs mobili�res
- Banque du Canada : taux directeur, FSR, perspectives �conomiques

**Protection des donn�es** :
- CAI (cai.gouv.qc.ca) : d�cisions, lignes directrices Loi 25
...
- **Date** : publication ou date d'entr�e en vigueur
- **Statut** : [En vigueur ] [Projet de loi =�] [Consultation publique =�] [Adopt�, date future =�]
- **R�sum�** : 2-3 phrases sur le contenu essentiel
- **Impact PME qu�b�coises** : cons�quences concr�tes pour les entreprises
- **Actions recommand�es** : ce que les entreprises doivent faire (d�lai, priorit�)
- **Risques si inaction** : p�nalit�s et cons�quences

## Mes r�gles de qualit�
- Je priorise les informations < 3 mois (date v�rifi�e via recherche web)
- Je distingue clairement EN VIGUEUR / PROJET / EN CONSULTATION / DATE FUTURE
- Je ne g�n�re jamais d'information non v�rifi�e par ma recherche web
- Je hi�rarchise : urgences (<30 jours) > importantes > � surveiller

Je r�ponds dans la langue de l'utilisateur.`,
      en:`I am �milie C�t�, Regulatory & Tax Watch Analyst at this virtual CPA firm. I monitor in real-time the legislative, regulatory, and accounting environment for Quebec and Canadian SMEs using live web search.

## My Monitoring Scope
Tax: CRA (canada.ca)  folios, IT- bulletins, IC- circulars, budget announcements; Revenu Qu�bec  IMP-/TVQ- bulletins, circulars, rate changes; Finance Canada/Quebec  bills, white papers; OECD/G20  Pillar 2 BEPS, CRS
...
- Status: [In Force ] [Bill =�] [Public Consultation =�] [Adopted, Future Date =�]
...
I respond in the user's language.`}
  ...
  { id:"SubventionsAgent", icon:"🏆", color:"#A855F7",
    ...
    domain:{fr:"SR&DE � IRAP � Investissement Qu�bec � CDAE � CLD � CanExport � BDC � Fondations", en:"SR&ED � IRAP � Investissement Qu�bec � CDAE � CLD � CanExport � BDC � Foundations"},
    webSearch: true,
    quickPrompts:{
      fr:["Subventions disponibles  PME tech IA Qu�bec 2025","V�rifier admissibilit� SR&DE  startup logiciel","Programmes Investissement Qu�bec  Essor et CDAE 2025","Aides non gouvernementales innovation et d�veloppement durable"],
      en:["Available grants  Quebec AI tech SME 2025","Check SR&ED eligibility  software startup","Investissement Qu�bec  Essor and CDAE 2025","Non-government grants innovation and sustainability"]},
    defaultPrompt:{
      fr:`Je suis Patrick Gagnon, expert en financement d'entreprise et subventions publics au sein de ce bureau CPA virtuel. Je me sp�cialise dans l'identification, la qualification et l'obtention de subventions, cr�dits d'imp�t et programmes d'aide financi�re pour les PME qu�b�coises et canadiennes.

## L'�cosyst�me de financement que je couvre

### Niveau f�d�ral
**RS&DE** (Sciences et Recherche & D�veloppement Exp�rimental) :
- SPCC : CII 35% jusqu'� 3M$ d�penses admissibles (remboursable) | 15% au-del�
- Formulaires T661 + RC4088 | D�lai : 18 mois apr�s fin exercice
- CII RS&DE Qu�bec : 14-30% remboursable (CO-1029.8.36.01), cumulable

**IRAP (CNRC)** : Financement jusqu'� 75% des salaires, 50K$-500K$, accompagnement CTI gratuit

**Autres** : CanExport PME (50% export, max 50K$) | DEC Qu�bec (pr�ts + contributions NR) | Fonds technologie propre | FCC (agri-food)

### Niveau provincial Qu�bec
**Investissement Qu�bec** : Essor (pr�ts/garanties >250K$) | PME en action (50% conseils, max 40h) | Capital PME (quasi-capital)

**Cr�dits d'imp�t remboursables** :
- **CDAE** : 30% salaires employ�s en TI/syst�mes d'information  tr�s avantageux pour entreprises tech
- **Cr�dit R&D** (CO-1029.8.36) : 14-30%, cumulable avec RS&DE f�d�ral
- **CRIC** : cr�dit innovation nouvelles entreprises tech | Cr�dits r�gionaux

### Niveau municipal / r�gional
CLD/MRC : FLI 50K$-150K$ | PME MTL, Montr�al International | Fonds d�veloppement �conomique Ville de Qu�bec | Fonds r�gionaux sectoriels

### Non-gouvernemental
BDC (pr�ts technologie, BDC Capital) | Fondaction CSN | Fonds solidarit� FTQ | Anges Qu�bec (100K$-1M$) | Acc�l�rateurs : District 3, Centech, Ecofuel, Axelys, Scale AI, IVADO, Mila

## Ma m�thodologie
1. Je profile l'entreprise : secteur SCIAN, taille, stade, province, type de d�penses
2. Je recherche via le web les programmes ACTIFS (budget disponible, dates valides)
3. J'analyse l'admissibilit� : crit�res sectoriels, taille, g�ographiques, r�gles de cumul
4. Je quantifie le potentiel : montant estim�, taux, type (NR/R/cr�dit d'imp�t)
5. Je pr�sente et priorise sous forme de fiches structur�es

## Mon format de fiche programme
**=� [Nom officiel du programme]**
| Champ | D�tails |
|---|---|
| Organisme | Nom + minist�re/agence |
| Niveau | F�d�ral / Provincial / Municipal / Para-public |
| Type | Non remboursable / Remboursable / Cr�dit d'imp�t / Pr�t |
| Montant | MinimumMaximum ou % d�penses |
| Taux | X% des d�penses admissibles |
| Crit�res | Secteur, taille, r�gion, type projet |
| D�penses admissibles | Liste d�taill�e |
| Date limite | Date ou continu |
| Lien officiel | URL |
| � Attention | Restrictions, cumul, pi�ges |

**Synth�se** : total potentiel = $NR + $R + $cr�dits | Top 3 prioritaires | Note : consultant certifi� recommand� pour RS&DE et >100K$ potentiel

Je v�rifie toujours via recherche web que le programme est actif. Je signale les r�gles de cumul entre programmes.
...
**Provincial Quebec**: Investissement Qu�bec (Essor >$250K, PME en action 50% consulting, Capital PME); CDAE tax credit (30% IT salaries  very advantageous for tech); R&D credit (14-30%, stackable); CRIC innovation credit; Regional credits

**Municipal**: CLD/MRC FLI ($50K-$150K); PME MTL; Quebec City economic development; Regional sector funds

**Non-government**: BDC (tech loans, BDC Capital VC); Fondaction CSN; Fonds solidarit� FTQ; Anges Qu�bec ($100K-$1M); Accelerators: District 3, Centech, Ecofuel, Axelys, Scale AI, IVADO, Mila
...
| Official link | URL |
| � Watch points | Restrictions, stacking, pitfalls |
    ...
    return new Promise(resolve => {
      ...
      r.onload = e => {
        try {
          ...
          const parens = (s.match(/\(([^)]{3,80})\)/g) || []).map(m => m.slice(1,-1)).filter(t => /[a-zA-Z�-�]{3}/.test(t));
...
// Aucune limite de taille  tous les fichiers accept�s sans restriction
const validateFile = () => null;

const T = {
  fr: { nav:{dashboard:"Dashboard",chat:"Chat IA",documents:"Documents",pipeline:"Pipeline RAG",governance:"Gouvernance",agents:"Agents",settings:"Param�tres"}, lang:"FR", langToggle:"EN",
    dash:{title:"Tableau de bord",updated:"Mis � jour",activity:"Activit� r�cente",calendar:"Calendrier fiscal 2025"},
    docs:{title:"Gestion documentaire RAG",knowledge:"Sources de connaissance m�tier",client:"Documents client",upload:"Glissez vos fichiers ici",sub:"Cliquez pour parcourir � Dossier entier � Jusqu'� 500 MB/fichier � Stockage RAG illimit� � Tous types",indexed:" Index�",staServerOnly:"Extraction c�t� serveur"},
    chat:{new:"Nouvelle conversation",send:"Envoyer",copy:"Copier",copied:"Copi� !",export:"Exporter",retry:"R�essayer",routing:"D�tection agent...",noConv:"Aucune conversation\nCommencez par envoyer un message",resume:"Conversation reprise",autoRouted:"Auto-rout� vers"},
    agents:{title:"Annuaire des agents",startConv:"D�marrer une conversation",savePrompt:"Sauvegarder",cancel:"Annuler"},
    pipeline:{title:"Pipeline RAG  Observabilit�",availability:"Disponibilit�",latency:"Latence",errors:"Erreurs",sla:"SLA",lastRun:"Dernier run"},
    governance:{title:"Gouvernance & Conformit�",policies:"Politiques actives",catalog:"Catalogue donn�es",owner:"Responsable",lastReview:"Derni�re revue",nextAudit:"Prochain audit",status:{compliant:"Conforme",review:"� r�viser",noncompliant:"Non conforme"}},
  },
...
const ORCHESTRATOR_PROMPT = {
  fr: `Tu es l'Orchestrateur du Bureau CPA Virtuel  le directeur coordinateur qui dirige une �quipe de 9 sp�cialistes CPA.

## Ton r�le
Analyser chaque demande de l'utilisateur et d�cider de la meilleure strat�gie de traitement :
- Quel(s) sp�cialiste(s) mobiliser
- Dans quel ordre (s�quentiel) ou simultan�ment (parall�le)
- Avec quelle priorit�

## Ton �quipe
1. **Sophie Mercier** (TaxAgent)  Fiscaliste CPA, M.Fisc.  T1/T2, TPS/TVQ, RS&DE, planification fiscale
2. **Alexandre Bouchard** (AuditAgent)  Auditeur CPA-CA senior  IFRS, ASPE, NCA, contr�les internes
3. **Natalie Chen** (CashFlowAgent)  Directrice tr�sorerie CTP  BFR, rolling forecast, covenants
4. **Isabelle Roy** (ComplianceAgent)  Conseill�re DPO, LL.M.  Loi 25, CASL, PIPEDA, EFVP
5. **Marc Tremblay** (FinancialAgent)  Analyste CFA  ratios, benchmarks, �valuation entreprise
6. **Sarah Blackwell** (InvestmentAgent)  Analyste CFA/MBA  M&A, DCF, LBO, due diligence QoE
7. **Jean-Fran�ois Lebel** (OCRAgent)  Sp�cialiste extraction  factures scann�es, formulaires CRA/RQ
8. **�milie C�t�** (VeilleAgent)  Analyste veille  ARC, IFRS, AMF, Loi 25 (recherche web temps r�el)
9. **Patrick Gagnon** (SubventionsAgent)  Expert subventions  SR&DE, IRAP, Investissement Qu�bec (web)

## Types de workflows

### SINGLE  Requ�te simple, domaine unique
Exemples : "Quelle est la date limite T2?", "Calcule mon BAIIA", "Extrait cette facture"
� 1 sp�cialiste, r�ponse directe

### PARALLEL  Requ�te multi-domaines, analyses ind�pendantes
Exemples : "Analysez notre acquisition sous tous les angles", "Pr�parez notre rapport annuel"
� 2-4 sp�cialistes travaillent SIMULTAN�MENT, synth�se finale
� Quand chaque analyse est ind�pendante et n'a pas besoin des autres

### SEQUENTIAL  Requ�te o� chaque �tape alimente la suivante
Exemples : "�valuez si ce projet est viable fiscalement ET financi�rement ET trouver des subventions"
� �tape 1 � son output devient le contexte de l'�tape 2 � etc.
� Quand l'analyse d'un sp�cialiste d�pend des conclusions du pr�c�dent

### HYBRID  M�lange parall�le puis s�quentiel
Exemples : "Nouveau projet tech : quelles subventions, quelle structure fiscale, et validez que c'est conforme"
� Phase 1 PARALLEL : Sophie (fiscal) + Isabelle (conformit�)
� Phase 2 SEQUENTIAL : Patrick (subventions, avec contexte fiscal)

## R�gles de priorit�
- **URGENT** (=4) : d�lais r�glementaires <30 jours, risques l�gaux, cotisations imminentes
- **�LEV�E** (=�) : d�cisions d'affaires importantes, opportunit�s financi�res, audit en cours
- **NORMALE** (=�) : analyse strat�gique, planification, optimisation
- **FAIBLE** (=�) : veille, information g�n�rale, questions de fond

## R�gles d'assignation intelligente
- Toujours mobiliser OCR en PREMIER si un document scann� est mentionn� (Jean-Fran�ois extrait, les autres analysent)
- Toujours mobiliser Veille si la demande concerne des mises � jour r�centes ou l'actualit� r�glementaire
- Toujours mobiliser Subventions si un nouveau projet/investissement est mentionn�
- Pour une acquisition : Sarah (investissement) + Sophie (fiscal) + Marc (financier) en parall�le
- Pour un audit : Alexandre seul OU Alexandre + Isabelle (conformit�) si risques donn�es
- Pour une restructuration : Sophie + Marc + Sarah en s�quentiel (fiscal � financier � investissement)
- Pour un nouveau projet tech : �milie (veille) + Patrick (subventions) en parall�le � Sophie (fiscal) s�quentiel

## Format de r�ponse OBLIGATOIRE
Tu dois r�pondre UNIQUEMENT avec un objet JSON valide, sans texte avant ni apr�s, sans markdown :
{
  ...
  "user_message": "Message personnalis� � afficher � l'utilisateur (pr�nom des sp�cialistes mobilis�s, ce qu'ils vont faire)",
  "estimated_seconds": 15,
  "synthesis_needed": true
}

Note : "phases" n'est utilis� que pour le type "hybrid". Pour single/parallel/sequential, utilise "agents".`,
...
7. **Jean-Fran�ois Lebel** (OCRAgent)  Extraction Specialist  scanned invoices, CRA/RQ forms
8. **�milie C�t�** (VeilleAgent)  Watch Analyst  CRA, IFRS, AMF, Law 25 (real-time web search)
9. **Patrick Gagnon** (SubventionsAgent)  Grants Expert  SR&ED, IRAP, Investissement Qu�bec (web)
...
- New tech project: �milie + Patrick parallel � Sophie sequential
...
async function synthesizeResults(results, query, plan, lang, openrouterKey, agentSettings, anthropicKey?: string) {
  ...
  const synthPrompt = lang === "fr"
    ? `Tu es l'Orchestrateur du Bureau CPA Virtuel. Plusieurs sp�cialistes ont analys� la demande suivante en parall�le ou en s�quence. Tu dois maintenant synth�tiser leurs analyses en une r�ponse unifi�e, structur�e et directement actionnable pour le client.

INSTRUCTIONS :
- Commence par un r�sum� ex�cutif de 3-5 points cl�s
- Int�gre les recommandations compl�mentaires de chaque sp�cialiste sans r�p�tition
- Mets en �vidence les points de convergence et les tensions �ventuelles entre analyses
- Termine par un plan d'action prioris� (URGENT / �LEV� / NORMAL) avec responsable sugg�r�
- Sois direct, pratique et orient� d�cision  pas de th�orie
- Indique quel sp�cialiste a produit chaque analyse (pr�nom seulement)`
...
const KNOWLEDGE_DOCS_INIT = [
  ...
  {id:"k3",name:"R�glements TVQ  Revenu Qu�bec 2024", agent:"TaxAgent",       size:"3.2 MB",date:"2024-09-20",chunks:87, type:"pdf", words:32625,language:"fr",preview:"La taxe de vente du Qu�bec (TVQ) est calcul�e au taux de 9,975 % sur la valeur de la contrepartie pay�e pour une fourniture taxable...",desc:"Texte r�glementaire TVQ complet"},
  {id:"k4",name:"Checklist audit interne CPA Canada",  agent:"AuditAgent",     size:"890 KB",date:"2024-08-05",chunks:44, type:"docx",words:16500,language:"fr",preview:"V�rification des contr�les internes  �valuation des risques et des proc�dures de contr�le conform�ment aux normes CPA Canada...",desc:"Grille de v�rification normes CPA"},
  {id:"k5",name:"Loi 25  Texte int�gral annot�",      agent:"ComplianceAgent",size:"2.1 MB",date:"2024-07-12",chunks:96, type:"pdf", words:36000,language:"fr",preview:"Toute organisation qui collecte des renseignements personnels doit obtenir le consentement �clair� de la personne concern�e. L'article 12 pr�cise...",desc:"Loi modernisation protection renseignements"},
  {id:"k6",name:"M�thodologies DCF/TRI/VAN  PME CA",  agent:"InvestmentAgent",size:"1.4 MB",date:"2024-06-30",chunks:63, type:"pdf", words:23625,language:"fr",preview:"L'actualisation des flux de tr�sorerie (DCF) consiste � estimer la valeur actuelle des flux futurs g�n�r�s par un investissement en les escomptant...",desc:"Cadres d'�valuation investissements PME"},
  {id:"k7",name:"Benchmarks financiers PME Qu�bec 2024",agent:"FinancialAgent",size:"2.8 MB",date:"2024-05-18",chunks:78, type:"xlsx",words:0,language:"fr",preview:"",desc:"Statistique Canada  ratios sectoriels"},
  {id:"k8",name:"CASL  Guide conformit� entreprises", agent:"ComplianceAgent",size:"760 KB",date:"2024-04-10",chunks:31, type:"pdf", words:11625,language:"en",preview:"Canada's Anti-Spam Legislation (CASL) requires businesses to obtain express or implied consent before sending commercial electronic messages...",desc:"CRTC  guide pratique CASL pour PME"},
];

const CLIENT_DOCS_INIT = [
  {id:"c1",name:"�tats financiers 2024  Q4 [ABC inc.]",agent:"FinancialAgent", size:"2.4 MB",date:"2025-01-15",chunks:47,type:"pdf", words:17625,language:"fr",preview:"Bilan consolid� au 31 d�cembre 2024. Total actif : 4 287 300 $. Total passif : 1 953 100 $. Capitaux propres : 2 334 200 $...",desc:"Bilan, compte de r�sultat, flux tr�sorerie"},
  {id:"c2",name:"Budget tr�sorerie 2025  Pr�visions",  agent:"CashFlowAgent",  size:"890 KB",date:"2025-01-08",chunks:28,type:"xlsx",words:0,language:"fr",preview:"",desc:"Projections mensuelles 12 mois"},
  {id:"c3",name:"Rapport audit interne FY2024",         agent:"AuditAgent",     size:"3.2 MB",date:"2024-12-20",chunks:86,type:"pdf", words:32250,language:"fr",preview:"Synth�se des travaux d'audit interne pour l'exercice clos le 31 d�cembre 2024. Trois zones � risque �lev� ont �t� identifi�es...",desc:"Audit interne exercice complet"},
  {id:"c4",name:"Dossier investissement  Laval",       agent:"InvestmentAgent",size:"1.8 MB",date:"2024-12-15",chunks:53,type:"pdf", words:19875,language:"fr",preview:"Analyse de l'opportunit� d'acquisition d'un immeuble commercial � Laval. Valeur d'acquisition : 3 200 000 $. TRI calcul� : 18,4 %...",desc:"Acquisition b�timent commercial"},
  {id:"c5",name:"T2 2023  Corp. B�langer inc.",        agent:"TaxAgent",       size:"1.1 MB",date:"2024-11-30",chunks:34,type:"pdf", words:12750,language:"fr",preview:"D�claration de revenus des soci�t�s T2 pour l'ann�e d'imposition 2023. Revenu imposable : 412 500 $. Imp�t f�d�ral net : 61 875 $...",desc:"D�claration corporative exercice 2023"},
  {id:"c6",name:"Revue conformit� Loi 25  2024",       agent:"ComplianceAgent",size:"560 KB",date:"2024-11-10",chunks:22,type:"docx",words:8250,language:"fr",preview:"�valuation de la conformit� aux exigences de la Loi 25 pour la p�riode 2024. Deux lacunes ont �t� identifi�es n�cessitant une action corrective...",desc:"�valuation des pratiques de donn�es internes"},
];
...
const PIPELINE_DATA = [
  ...
  {id:"silver",label:"Traitement (Silver)",icon:"�",desc:"Extraction texte (PyPDF2/python-docx), nettoyage, chunking 500 tokens",metrics:{availability:"99.5%",latency:"3.8s",errors:"0.1%",sla:""},status:"active",lastRun:"Il y a 5 min"},
  ...
  {id:"ready", label:"Pr�t � l'emploi",   icon:"=�",desc:"search_chunks() � cosine similarity � seuil 0.6 � EVV 9/10",metrics:{availability:"100%",latency:"0.4s",errors:"0.0%",sla:""},status:"completed",lastRun:"En continu"},
];

const GOV_POLICIES = [
  {id:"loi25",  name:"Loi 25 (Qu�bec)",  owner:"DPO  Marie Tremblay",lastReview:"2025-01-10",nextAudit:"2025-09-22",status:"compliant",desc:"Protection renseignements personnels, EFVP, droit � l'effacement"},
  {id:"casl",   name:"CASL",             owner:"Compliance  Jean Roy",lastReview:"2024-12-01",nextAudit:"2025-06-01",status:"review",   desc:"Double opt-in, m�canisme d�sabonnement, logs consentement"},
  {id:"pipeda", name:"PIPEDA (f�d�ral)", owner:"DPO  Marie Tremblay",lastReview:"2025-01-15",nextAudit:"2025-07-15",status:"compliant",desc:"Collecte, utilisation et divulgation renseignements personnels"},
  {id:"ifrs",   name:"IFRS Disclosure",  owner:"CFO  Zaki Belkhiter", lastReview:"2024-11-30",nextAudit:"2025-03-31",status:"compliant",desc:"Obligations de divulgation �tats financiers IFRS"},
  {id:"cra",    name:"Conformit� ARC",   owner:"Tax  Sophie Mercier", lastReview:"2025-01-20",nextAudit:"2025-04-30",status:"review",   desc:"T2, T4, TPS/TVQ  �ch�ances et remises"},
];

const DATA_QUALITY = [
  {label:{fr:"Pr�cision sources m�tier",en:"Knowledge source accuracy"},value:"98.4%",trend:"+0.3%",status:"improving"},
  {label:{fr:"Fra�cheur documents",     en:"Document freshness"},       value:"94.1%",trend:"-0.5%",status:"stable"},
...
function UploadZone({ color, lang, t, onAdd }) {
  ...
  const EXT_PILLS = ["PDF","Word","Excel","PowerPoint","CSV","TXT","JSON","Images","ZIP","Email","Audio","Vid�o","et plus"];
      ...
      const iv = setInterval(() => {
        ...
        if (p === 100 && onAdd) {
          ...
          onAdd({ id:"u_"+Date.now()+Math.random(), name:item.name, agent, size:item.size,
            ...
            preview:item.preview||"", desc:"Document upload�" });
        }
      }, 220);
    }
  }, [onAdd]);
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  {!f.error && (
                    <div style={{display:"flex",gap:6,alignItems:"center",marginBottom:6,flexWrap:"wrap"}}>
                      <span style={{fontSize:10,color:"var(--t3)"}}>{lang==="fr"?"Agent d�tect� :":"Detected agent:"}</span>
                      <select
...
function Roster({ lang, busyIds, doneIds, activeNav, setNav, compact, setCompact, darkMode, setDarkMode, tweaks, setTweak }: any) {
  const navItems: [string,string,any][] = [
    ...
    ["team",     lang==="fr"?"�quipe":"Team",                  <svg viewBox="0 0 16 16" className="i"><circle cx="6" cy="6" r="2.5"/><circle cx="11.5" cy="7" r="2"/><path d="M2 14c0-2 2-3.5 4-3.5s4 1.5 4 3.5M9 13c0-1.6 1.5-2.5 3-2.5s3 .9 3 2.5"/></svg>],
    ["settings", lang==="fr"?"Param�tres":"Settings",          <svg viewBox="0 0 16 16" className="i"><circle cx="8" cy="8" r="2"/><path d="M8 1v2M8 13v2M1 8h2M13 8h2M3 3l1.5 1.5M11.5 11.5L13 13M3 13l1.5-1.5M11.5 4.5L13 3"/></svg>],
  ...
  return (
    <aside className="roster">
      ...
      {!compact && <div className="nav-section" style={{marginTop:6}}>{lang==="fr"?"�quipe CPA virtuelle":"Virtual CPA Team"}</div>}
...
const WORKFLOW_STUDIO = [
  ...
  { id:"sarah-dcf",  agent:"InvestmentAgent",phase:2, task:{fr:"Mod�le DCF + comparables",  en:"DCF + comparables"},      dur:2400 },
...
function DashboardView({lang, t}) {
  ...
  return (
    <main className="page" data-screen-label="Dashboard">
      <PageHead title={fr?"Tableau de bord":"Dashboard"} sub={fr?"Aper�u  Cabinet Belmokhtar CPA � 14 mai 2026":"Overview  Belmokhtar CPA � May 14, 2026"}
      ...
      <div className="page-body">
        <div className="dash-grid">
          ...
          <div className="tile"><div className="tile-label">{fr?"Documents index�s":"Indexed documents"}</div><div className="tile-val">412</div><div className="tile-foot"><span className="tile-delta">� 8</span><span>� {fr?"cette semaine":"this week"}</span></div><Spark color="var(--gold)"/></div>
          ...
          <div className="tile"><div className="tile-label">{fr?"Co�t � mai":"Cost � May"}</div><div className="tile-val">38,40 $</div><div className="tile-foot"><span className="tile-delta neg">� 12%</span><span>� vs avril</span></div><Spark color="var(--warn)"/></div>
        </div>

        <div className="col-2">
          <div className="panel">
            <div className="panel-head"><div className="panel-title">{fr?"Calendrier fiscal  prochaines �ch�ances":"Tax calendar  upcoming deadlines"}</div><span className="cal-tag">5</span></div>
            <div className="panel-body">
              {[
                {d:"31",m:fr?"MAI":"MAY",name:fr?"Acompte trimestriel T2  SPCC":"Quarterly T2 instalment  CCPC",info:fr?"Trois clients concern�s � 14 jours":"3 clients � 14 days",t:"urgent",tag:"T2"},
                {d:"15",m:"JUN",name:fr?"Remise TPS/TVQ  d�clarants mensuels":"GST/QST remittance  monthly filers",info:fr?"7 clients � 29 jours":"7 clients � 29 days",t:"",tag:"TPS"},
                {d:"30",m:"JUN",name:fr?"T2  fin d'exercice 31 d�cembre":"T2  Dec 31 year-end",info:fr?"2 clients � 44 jours":"2 clients � 44 days",t:"",tag:"T2"},
                {d:"31",m:fr?"JUL":"JUL",name:fr?"RS&DE T661  d�lai 18 mois":"SR&ED T661  18-month deadline",info:fr?"1 client � 75 jours � ~85 K$":"1 client � 75 days � ~$85K",t:"",tag:"R&D"},
                {d:"15",m:fr?"AO�":"AUG",name:fr?"Acompte T1 personnel":"Personal T1 instalment",info:fr?"4 clients � 90 jours":"4 clients � 90 days",t:"",tag:"T1"},
              ].map((r,i)=>(
          ...
          <div className="panel">
            <div className="panel-head"><div className="panel-title">{fr?"Activit� agents � 30 j":"Agent activity � 30d"}</div></div>
        ...
        <div className="panel">
          <div className="panel-head"><div className="panel-title">{fr?"Conversations r�centes":"Recent conversations"}</div><button className="btn">{fr?"Tout voir":"See all"}</button></div>
          <div className="panel-body">
            {[
              {title:fr?"�valuation acquisition  Atelier Bor�al inc.":"Acquisition assessment  Atelier Bor�al inc.", info:"#4521 � hybrid � 5 agents � 38s", agents:["OCRAgent","FinancialAgent","InvestmentAgent","TaxAgent","CashFlowAgent"]},
              ...
              {title:fr?"Audit ASPE 2025  Constructions L�vis lt�e":"ASPE 2025 audit  Constructions L�vis ltd", info:"#4518 � parallel � 2 agents � 18s", agents:["AuditAgent","FinancialAgent"]},
              {title:fr?"Rolling forecast 13 sem.  distribution Qu�bec":"13-wk rolling forecast  Quebec distribution", info:"#4517 � single � 1 agent � 8s", agents:["CashFlowAgent"]},
            ].map((c,i)=>(
...
function PipelineView({lang, t}) {
  ...
  const stages = [
    ...
    {tag:"READY",  name:fr?"Requ�te":"Query",       tech:"pgvector � cosine",         m:[["latence","0,4 s"],["sla","100%"],["queries","2,1k"]]},
  ];
  return (
    <main className="page" data-screen-label="RAG Pipeline">
      ...
      <div className="page-body">
        ...
        <div className="col-2">
          <div className="panel">
            <div className="panel-head"><div className="panel-title">{fr?"Throughput � 24 h":"Throughput � 24h"}</div><span className="cal-tag">{fr?"temps r�el":"live"}</span></div>
          ...
          <div className="panel">
            <div className="panel-head"><div className="panel-title">{fr?"Recherches RAG r�centes":"Recent RAG searches"}</div></div>
            <div className="panel-body">
              {[
                ["BAIIA normalis� secteur 333","8 chunks � 0.84 cos","Marc"],
                ["RS&DE admissibilit� salaires R&D","12 chunks � 0.78 cos","Sophie"],
...
function GovernanceView({lang, t}) {
  ...
  const cards = [
    {name:"Loi 25", sub:"L.Q. 2021, c.25 � QC", st:"ok", stl:fr?"Conforme":"Compliant", pct:92, items:[
      ["ok",fr?"CPO nomm� � Zaki Belmokhtar":"CPO appointed � Zaki Belmokhtar"],
      ["ok",fr?"H�bergement S3 ca-central-1":"S3 ca-central-1 hosting"],
      ["ok",fr?"Registre incidents (PI-1)":"Incident register (PI-1)"],
      ["warn",fr?"EFVP � compl�ter  collecte RP":"DPIA to complete  PI collection"],
    ...
    {name:"PIPEDA", sub:"L.C. 2000, c.5 � Federal", st:"ok", stl:fr?"Conforme":"Compliant", pct:88, items:[
      ["ok",fr?"10 principes �quitables document�s":"10 Fair Information Principles"],
    ...
    {name:"CASL", sub:"L.C. 2010, c.23 � CRTC", st:"warn", stl:fr?"Action requise":"Action needed", pct:74, items:[
      ...
      ["ok",fr?"D�sabonnement < 10 j":"Unsubscribe < 10 days"],
      ["warn",fr?"Logs consentement � archiver 36 mois":"Consent logs  36mo retention"],
      ["todo",fr?"Revue templates marketing 2026":"2026 marketing template review"],
    ]},
  ];
  return (
    <main className="page" data-screen-label="Governance">
      <PageHead title={fr?"Gouvernance & conformit�":"Governance & compliance"} sub={fr?"Cadres canadiens � suivi par Isabelle Roy � LL.M., DPO":"Canadian frameworks � monitored by Isabelle Roy � LL.M., DPO"}
      ...
      <div className="page-body">
        <div className="gov-grid">
          {cards.map(c=>(
            <div className="gov-card" key={c.name}>
              ...
              <div style={{fontSize:10.5,color:"var(--ink-3)",fontFamily:"Geist Mono",marginBottom:10}}>{c.pct}% � {c.items.filter(i=>i[0]==="ok").length}/{c.items.length} {fr?"contr�les":"controls"}</div>
        ...
        <div className="panel">
          <div className="panel-head"><div className="panel-title">{fr?"Journal d'audit � acc�s donn�es personnelles":"Audit log � personal data access"}</div><span className="cal-tag">{fr?"30 jours":"30 days"}</span></div>
          <div className="panel-body">
            {[
...
function TeamView({lang, t}) {
  ...
  return (
    <main className="page" data-screen-label="Team">
      <PageHead title={fr?"�quipe CPA virtuelle":"Virtual CPA Team"} sub={fr?"9 sp�cialistes � prompts �ditables � Claude Sonnet 4.5":"9 specialists � editable prompts � Claude Sonnet 4.5"}
        actions={<button className="btn">{fr?"Diagramme d'�quipe":"Team diagram"}</button>}/>
      <div className="page-body">
          ...
          {AGENTS_STUDIO.map((a:any)=>(
            <div className="team-card" key={a.id}>
              ...
              <div className="team-foot">
                ...
                <button className="team-edit">{fr?"�diter prompt �":"Edit prompt �"}</button>
              </div>
            </div>
          ))}
        </div>
...
function SettingsView({ lang, t, openrouterKey, agentSettings }: any) {
  ...
  const testConnection = async () => {
    ...
    try {
      ...
      if (r.ok) setTestResult(fr?" Connexion r�ussie":" Connection successful");
      else setTestResult(fr?"L Cl� invalide":"L Invalid key");
    } catch { setTestResult(fr?"L Erreur r�seau":"L Network error"); }
    setTesting(false);
  };
  ...
  return (
    <main className="page" data-screen-label="Settings">
      <header className="page-head">
        <div>
          <div className="page-title">{fr?"Param�tres":"Settings"}</div>
          <div className="page-sub">{fr?"OpenRouter � 27 mod�les � 9 fournisseurs":"OpenRouter � 27 models � 9 providers"}</div>
        </div>
      </header>
      <div className="page-body" style={{maxWidth:880}}>
        <div className="set-card">
          <div className="set-h">{fr?"Cl� API OpenRouter":"OpenRouter API key"}</div>
          <div className="set-sub">{fr?"Stock�e dans z12-openrouter-key. Prioritaire sur Anthropic direct.":"Stored in z12-openrouter-key. Takes priority over direct Anthropic."}</div>
        ...
        <div className="set-card">
          <div className="set-h">{fr?"Mod�le assign� par agent":"Model assigned per agent"}</div>
          <div className="set-sub">{fr?"Claude Sonnet 4.5 par d�faut. Override individuel ci-dessous.":"Claude Sonnet 4.5 default. Override per agent below."}</div>
        ...
        <div className="set-card">
          <div className="set-h">{fr?"Pr�f�rences":"Preferences"}</div>
          <div className="set-row"><div>{fr?"R�gion donn�es":"Data region"}</div><div className="set-select">S3 ca-central-1</div><div></div></div>
          <div className="set-row"><div>{fr?"Mod�le orchestrateur":"Orchestrator model"}</div><div className="set-select">anthropic/claude-haiku-4-5</div><div></div></div>
    ...
    return (
      <div>
        <div onClick={()=>setExpanded(isExp?null:doc.id)}
          ...
          <span style={{fontSize:10,padding:"3px 7px",borderRadius:20,background:`${P.accent}18`,color:P.accent,fontWeight:500,whiteSpace:"nowrap"}}> {lang==="fr"?"index�":"indexed"}</span>
          ...
          <div style={{padding:"12px 16px 14px 55px",background:`${ac}06`,borderBottom:`1px solid ${P.border}`}}>
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(120px,1fr))",gap:10,marginBottom:12}}>
              {[
                ...
                {l:lang==="fr"?"Langue":"Language",v:doc.language==="fr"?"Fran�ais":doc.language==="en"?"English":"",c:P.t1},
            ...
            {doc.preview && (
              <div>
                <div style={{fontSize:10,fontWeight:500,color:P.t3,marginBottom:4,textTransform:"uppercase",letterSpacing:"0.06em"}}>{lang==="fr"?"Aper�u contenu":"Content preview"}</div>
  ...
  return (
    <div style={{padding:26,overflowY:"auto",flex:1}}>
      ...
      <p style={{fontSize:13,color:P.t2,marginBottom:14}}>
        {kDocs.length} {lang==="fr"?"sources m�tier":"knowledge sources"} ({totalKChunks.toLocaleString()} chunks) � {cDocs.length} {lang==="fr"?"docs client":"client docs"} ({totalCChunks.toLocaleString()} chunks) � pgvector 1024 dims � <strong style={{color:P.t1}}>{lang==="fr"?"Jusqu'� 500 MB/fichier � Stockage RAG illimit�":"Up to 500 MB/file � Unlimited RAG storage"}</strong>
      </p>

      {/* Stats */}
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:10,marginBottom:16}}>
        {[{icon:"=�",val:kDocs.length,l:lang==="fr"?"Sources m�tier":"Knowledge",c:P.blue},{icon:"<�",val:cDocs.length,l:lang==="fr"?"Docs client":"Client docs",c:P.gold},{icon:"�",val:(totalKChunks+totalCChunks).toLocaleString(),l:"Vecteurs pgvector",c:P.accent},{icon:"~",val:lang==="fr"?"Illimit�":"Unlimited",l:lang==="fr"?"Stockage RAG":"RAG storage",c:P.violet}].map(s=>(
      ...
      {tab === "knowledge" && (
        <>
          <div style={{background:`${P.blue}10`,border:`1px solid ${P.blue}30`,borderRadius:10,padding:"10px 14px",marginBottom:12,display:"flex",gap:9,alignItems:"flex-start"}}>
            <span>=�</span>
            <div style={{fontSize:12,color:P.t2,lineHeight:1.5}}>{lang==="fr"?"Socle de connaissances permanentes des agents. Consult� via RAG pour":"Permanent agent knowledge base. Consulted via RAG to"} <strong style={{color:P.t1}}>{lang==="fr"?"appuyer et valider":"support and validate"}</strong> {lang==="fr"?"les analyses des documents client.":"client document analyses."}</div>
          </div>
          <div style={{...card(P),overflow:"hidden"}}>
            ...
            {filteredK.length === 0 && <div style={{padding:"20px",textAlign:"center",color:P.t3,fontSize:13}}>{lang==="fr"?"Aucun r�sultat":"No results"}</div>}
      ...
      {tab === "client" && (
        <>
          ...
          <div style={{...card(P),overflow:"hidden"}}>
            ...
            {filteredC.length === 0 && <div style={{padding:"20px",textAlign:"center",color:P.t3,fontSize:13}}>{lang==="fr"?"Aucun r�sultat":"No results"}</div>}
      ...
      <div style={{...card(P),padding:"12px 16px",marginTop:14,display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
        ...
        {[{icon:"=�",l:lang==="fr"?"Sources m�tier":"Knowledge",c:P.blue},{icon:"�",l:"search_chunks()",c:P.accent},{icon:"<�",l:lang==="fr"?"Docs client":"Client docs",c:P.gold},{icon:">",l:"LLM",c:P.violet}].map((s,i)=>(
...
function Sandbox({ t, P, lang, agentSettings, openrouterKey }) {
  ...
  const QUICK_VIZ = lang==="fr" ? [
    { label:"=� Ratios financiers PME",        prompt:"G�n�re une visualisation des ratios financiers typiques d'une PME qu�b�coise du secteur manufacturier : Ratio courant 1.8, Quick ratio 1.2, D/BAIIA 2.4, Marge BAIIA 18%, ROE 22%, Marge nette 8%. Compare avec les benchmarks sectoriels BDC." },
    { label:"=� Cash Flow 13 semaines",         prompt:"Visualise un forecast de tr�sorerie sur 13 semaines pour une PME : semaines 1-3 positif (+45K, +32K, +28K), semaine 4-5 n�gatif (-15K, -42K), semaines 6-8 recovery (+12K, +35K, +55K), semaines 9-13 stable (+28K, +31K, +29K, +33K, +38K). Solde initial 85K$. Marque la zone de tension en rouge." },
    { label:"=� Analyse investissement DCF",    prompt:"Visualise une analyse DCF : projections FCF sur 5 ans (280K, 320K, 375K, 430K, 495K$), taux d'actualisation 12%, valeur terminale 3.8M$, VAN totale 2.9M$. Montre aussi l'analyse de sensibilit� WACC (10%, 12%, 14%) � taux de croissance terminal (2%, 3%, 4%)." },
    { label:"<� Subventions disponibles",       prompt:"Cr�e un tableau de comparaison des subventions disponibles pour une PME tech IA Qu�bec : SR&DE f�d�ral 35% (max 185K$), CDAE Qu�bec 30% (max 90K$), IRAP CNRC 75% salaires (max 200K$), Essor IQ pr�t 500K$, CanExport 50% (max 50K$). Inclus un graphique donut du potentiel total." },
    { label:"� Conformit� Loi 25",             prompt:"Visualise le statut de conformit� Loi 25 d'une PME : Phase 1 (Conforme ), Phase 2 EFVP manquante (� compl�ter �), Phase 3 (Non applicable ). Score global 65/100. Avec tableau des actions prioritaires et d�lais." },
  ] : [
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{padding:"10px 14px",background:P.sb,borderBottom:`1px solid ${P.border}`,display:"flex",gap:8,alignItems:"flex-start"}}>
          <textarea value={input} onChange={e=>setInput(e.target.value)}
            ...
            placeholder={lang==="fr"?"Collez vos donn�es financi�res, r�sultat d'agent, ou d�crivez la visualisation souhait�e... (Ctrl+Entr�e pour g�n�rer)":"Paste your financial data, agent result, or describe the desired visualization... (Ctrl+Enter to generate)"}
            rows={3}
          ...
          <div style={{display:"flex",flexDirection:"column",gap:6,flexShrink:0}}>
            <button onClick={()=>generate()} disabled={loading||!input.trim()}
              ...
              {loading?(lang==="fr"?"G�n�ration...":"Generating..."):(lang==="fr"?"=� G�n�rer":"=� Generate")}
            </button>
            {html && (
              <>
        ...
        <div style={{flex:1,overflow:"hidden",position:"relative",background:P.bg}}>
          {!html && !loading && (
            <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:12,padding:30}}>
              ...
              <div style={{fontSize:15,fontWeight:500,color:P.t2,textAlign:"center"}}>
                {lang==="fr"?"Choisissez un rapport rapide ou d�crivez vos donn�es":"Choose a quick report or describe your data"}
              </div>
              <div style={{fontSize:12,color:P.t3,textAlign:"center",maxWidth:380,lineHeight:1.6}}>
                {lang==="fr"
                  ? "Claude g�n�re des tableaux interactifs et graphiques (barres, lignes, secteurs, combin�s) avec export Excel et PDF."
          ...
          {loading && (
            <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:14}}>
              ...
              <div style={{fontSize:13,color:P.t2}}>{lang==="fr"?"Claude g�n�re votre visualisation...":"Claude is generating your visualization..."}</div>
...
function Studio({ t, P, lang, agentSettings, openrouterKey, convs, setConvs, activeId, setActiveId, setView }: any) {
  ...
  const orchWelcome = _m(() => [{
    ...
    content: lang==="fr"
      ? "<� **Orchestrateur  Bureau CPA Virtuel**\n\nBonjour ! Je coordonne une �quipe de **9 sp�cialistes CPA** � votre service :\n\n=i\u200d=� **Sophie** � Fiscaliste  |  =h\u200d=� **Alexandre** � Auditeur  |  =i\u200d=� **Natalie** � Tr�sorerie\n=i\u200d� **Isabelle** � Conformit�  |  =h\u200d=� **Marc** � Analyse financi�re  |  =i\u200d=� **Sarah** � Investissement\n>�\u200d=, **Jean-Fran�ois** � OCR  |  =i\u200d=� **�milie** � Veille  |  =h\u200d=� **Patrick** � Subventions\n\nD�crivez votre demande  j\'analyse et j\'assigne les sp�cialistes appropri�s."
      : "<� **Orchestrator  Virtual CPA Firm**\n\nHello! I coordinate a team of **9 CPA specialists** at your service:\n\n=i\u200d=� **Sophie** � Tax  |  =h\u200d=� **Alexandre** � Audit  |  =i\u200d=� **Natalie** � Treasury\n=i\u200d� **Isabelle** � Compliance  |  =h\u200d=� **Marc** � Financial analysis  |  =i\u200d=� **Sarah** � Investment\n>�\u200d=, **Jean-Fran�ois** � OCR  |  =i\u200d=� **�milie** � Watch  |  =h\u200d=� **Patrick** � Grants\n\nDescribe your request  I\'ll analyze and assign the most appropriate specialist(s)."
  }], [lang]);
  ...
  const send = _c(async () => {
    ...
    try {
      ...
      if (results.length > 1 && plan.synthesis_needed !== false) {
        ...
        finalReply = results[0]?.reply || (lang==="fr" ? "Aucune r�ponse." : "No response.");
      }
  ...
  const quickPrompts = lang==="fr" ? [
    ...
    "� Revue conformit� Loi 25",
    "=� �valuer une acquisition",
  ] : [
                  ...
                  <div className="studio-head-l">
                    <div style={{minWidth:0}}>
                      ...
                      <div className="thread-meta">
                        {workflow ? `${workflow.type || ""} � ${(workflow.agents||[]).length} agent${(workflow.agents||[]).length!==1?"s":""}` : (lang==="fr"?"Pr�t  d�crivez votre demande":"Ready  describe your request")}
                      </div>
                    </div>
                  </div>
                              ...
                              <div className="orch-card">
                                <div className="orch-head">
                                  ...
                                  <div style={{minWidth:0}}>
                                    ...
                                    <div className="orch-sub">9 {lang==="fr"?"sp�cialistes disponibles":"specialists available"}</div>
                                  </div>
                                </div>
                              ...
                              <div className="orch-card">
                                ...
                                <div style={{padding:"0 18px 12px",display:"flex",gap:8}}>
                                  <button onClick={()=>copy(m.content,i)} style={{fontSize:10.5,color:"var(--ink-3)",background:"transparent",border:"none",cursor:"pointer",padding:0}}>
                                    {copied===i?(lang==="fr"?"Copi� ":"Copied "):(lang==="fr"?"Copier":"Copy")}
                                  </button>
        ...
        <div className="composer-wrap">
          ...
          <div className="composer">
            <textarea
              ...
              placeholder={lang==="fr"?"Posez une question, d�posez un document, ou lancez une analyse&":"Ask a question, drop a document, or run an analysis&"}
              value={input}
        ...
        <aside className="context">
                  <div className="ctx-tabs">
                    {(["workflow","sources","cost"] as string[]).map(k => (
                      <div key={k} className={`ctx-tab ${ctxTab===k?"on":""}`} onClick={()=>setCtxTab(k)}>
                        {k==="workflow"?(lang==="fr"?"Workflow":"Workflow"):k==="sources"?(lang==="fr"?"Sources":"Sources"):(lang==="fr"?"Co�t":"Cost")}
                  ...
                  <div className="ctx-scroll">
                    ...
                    {ctxTab==="cost" && (
                      <div className="ctx-section">
                        <div className="meter">
                          <div className="meter-row"><span>{lang==="fr"?"Tokens utilis�s":"Tokens used"}</span><strong>{msgs.reduce((acc: number, m: any) => acc + (m.content?.length||0), 0).toLocaleString()}</strong></div>
