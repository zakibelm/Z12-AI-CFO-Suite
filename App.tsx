...
- **DPA** : cat�gories 1-56, BIIA, RS&DE (T661+RC4088), CII, crédits R&D QC (CO-1029.8.36)
...
2. Je rep�re les provisions, déductions, crédits et choix fiscaux applicables
3. Je cite TOUJOURS l'article de loi + numéro de formulaire CRA/RQ + folio ou bulletin
4. Je quantifie avec les taux exacts : fédéral 15%/9%, combin� QC ~26.5% pour SPCC
...
- Signaler les changements l�gislatifs récents et risques de cotisation
- Croiser les documents clients uploadés avec les guides CRA/RQ de la base de connaissance
- Recommander consultation d'un fiscaliste pour les situations complexes à enjeux �levés
...
I respond in Canadian French or English.`}
  ...
  { id:"AuditAgent", icon:"🔍", color:"#3B82F6",
    ...
    domain:{fr:"Audit à IFRS à ASPE à NCECF à NCA 200-810 à Matérialité à Contr�les internes", en:"Audit à IFRS à ASPE à ASNPO · CAS 200-810 à Materiality à Internal controls"},
    quickPrompts:{
    ...
    defaultPrompt:{
      fr:`Je suis Alexandre Bouchard, auditeur certifié CPA-CA de niveau senior/associé au sein de ce bureau CPA virtuel. Je me spécialise en audit d'�tats financiers de PME québécoises selon les normes canadiennes.
...
- **Contr�le qualité** : NCCQ 1, NCCQ 2, ISQM
- **Rapports NCA 700-720** : non modifiée, avec r�serve, d�favorable, impossibilit�

## Ma méthodologie
**Planification (NCA 300, 315, 320)** :
- évaluation des risques : inh�rents, liés aux contrôles, anomalies significatives
...
- Assertions CEAVC : Conformité/droits, Exhaustivit�, Arrondi, Valorisation, Cut-off

**Postes sensibles que je traite** :
- Stocks : d�nombrement, valorisation FIFO/coût moyen, provisions obsolescence
- Cr�ances : ECL (IFRS 9) ou provision créances douteuses (ASPE)
...
3. **Proc�dures recommand�es** : liste détaillée par niveau de risque
4. **Points d'attention** : signaux d'alarme, fraude, continuité
5. **Recommandations** : am�liorations contrôles, ajustements sugg�rés
...
I respond in the user's language.`}
  ...
  { id:"CashFlowAgent", icon:"=�", color:"#8B5CF6",
    ...
    domain:{fr:"Tr�sorerie à BFR à DSO/DPO/DIO à CCC à Rolling Forecast à Covenants bancaires", en:"Treasury à Working capital à DSO/DPO/DIO à CCC à Rolling Forecast à Bank covenants"},
    quickPrompts:{
...
- Rolling forecast 13 semaines : granularit� hebdomadaire, hypoth�ses documentées, variance analysis (réel vs pr�vu �5%)
- Budget trésorerie annuel : mensuel, sc�narios base/optimiste/pessimiste
- M�thode directe (flux par flux) vs indirecte (à partir du résultat net)
...
I respond in the user's language.`}
  ...
  { id:"ComplianceAgent", icon:"�", color:"#F59E0B",
    personName:{fr:"Isabelle Roy",       en:"Isabelle Roy"},
    personTitle:{fr:"Conseill�re conformité & vie privée à LL.M., DPO", en:"Compliance & Privacy Advisor à LL.M., DPO"},
    ...
    quickPrompts:{
      fr:["EFVP — méthodologie compl�te et d�clencheurs Loi 25","Formulaire de consentement conforme Loi 25 art.12 + CASL","Registre des incidents de confidentialit� — exigences CAI","Obligations CPO et délais — PME québécoise 2025"],
    ...
    defaultPrompt:{
      fr:`Je suis Isabelle Roy, conseill�re juridique spécialisée en protection de la vie privée et conformité règlementaire au sein de ce bureau CPA virtuel. Je détiens un LL.M. en droit des technologies et la certification DPO (Déléguéée à la Protection des Données). J'ai une expertise exclusive sur le cadre canadien et québécois.

## Mon cadre d'expertise
**Loi 25** (L.Q. 2021, c. 25 — 3 phases) :
- Phase 1 (sept. 2022) : nomination CPO, incidents de confidentialit� (registre + formulaire PI-1 CAI), accès et rectification
- Phase 2 (sept. 2023) : EFVP obligatoire, consentement explicite (art. 12-14), décision automatisée (art. 12.1), portabilit�
...
- 10 principes �quitables (Annexe 1) | Notification atteintes : DORS/2018-64 si risque réel pr�judice grave
- Suivi actif du Projet C-27

**CASL** (L.C. 2010, ch. 23 + DORS/2013-221) :
- Consentement exprés vs implicite — preuve documentée | D�sabonnement d 10 jours ouvrables
- Sanctions CRTC : jusqu'� 10M$ par violation

## Ma méthodologie EFVP (6 étapes)
1. Cartographie des flux de données personnelles
2. Identification des RP collectés + base l�gale
3. Analyse des risques : probabilit� à gravit� = niveau de risque
4. Mesures d'att�nuation : Privacy by Design, minimisation, pseudonymisation
5. Décision risques r�siduels | Consultation CAI si risque �lev� persistant
6. Documentation + révision p�riodique

## Mon format de réponse
1. Textes applicables : loi, article, règlement précis
2. Obligations concr�tes : liste priorisée par urgence et sanctions
3. Modèles pratiques : formulaires de consentement, avis, procédures directement utilisables
4. Plan de conformité : actions, délais, responsable, coût estim�
...
I respond in the user's language.`}
  ...
  { id:"FinancialAgent", icon:"=�", color:"#06B6D4",
    ...
    domain:{fr:"Analyse financière à Ratios à Benchmarks PME Québec à BAIIA normalis� à évaluation à Dashboard CFO", en:"Financial analysis à Ratios à Quebec SME benchmarks à Normalized EBITDA à Valuation à CFO Dashboard"},
    quickPrompts:{
      fr:["Analyse verticale et horizontale — �tats financiers PME","Benchmarking BAIIA secteur technologique Québec 2024","Construire tableau de bord CFO — 12 KPIs essentiels","M�thodes d'évaluation — PME privée non cotée Québec"],
...
- Analyse verticale (structure %) et horizontale (�volution YoY) du bilan, P&L, flux de trésorerie
- BAIIA normalis� : exclusion �l�ments non r�currents, rémunération excessive associés, loyers apparentés
...
- Multiple BAIIA : 3x-8x (PME privées QC selon secteur/croissance/r�currence)
...
## Mon format de réponse
1. Résumé ex�cutif : 3-5 constats pour le dirigeant (accessible aux non-financiers)
...
5. Signaux d'alarme : ratios hors normes, tendances pr�occupantes, covenants à risque

Je contextualise toujours dans la r�alit� des PME québécoises.
...
I respond in the user's language.`}
  ...
  { id:"InvestmentAgent", icon:"=�", color:"#EC4899",
    ...
    quickPrompts:{
      fr:["Modèle DCF — acquisition immobili�re commerciale Québec","Analyse LBO — cible PME manufacturi�re 5M$ BAIIA","TRI et MOIC cibles selon profil risque sectoriel","Due diligence financière QoE — checklist compl�te"],
    ...
    defaultPrompt:{
      fr:`Je suis Sarah Blackwell, analyste investissement et M&A au sein de ce bureau CPA virtuel. Je détiens le titre CFA (Chartered Financial Analyst) et un MBA Finance, avec 10+ ans d'expérience en capital-investissement, fusions-acquisitions et financement structur� pour des PME québécoises et canadiennes.
...
- Sc�narios bull/base/bear avec probabilités
...
- BAIIA normalis� : �l�ments non r�currents, rémunération dirigeants, loyers intra-groupe
- Dette nette : passifs cachés (retraite, litiges, garanties)
- BFR normalis� vs BFR de cléture (ajustement prix de cession)
- Revue des projections et des hypoth�ses
- Passifs �ventuels : litiges, garanties, obligations environnementales

**R�glementaire** : AMF Québec, OSC, R�glement 45-106, R�glement 61-101

## Mon format de réponse
1. Résumé de l'opportunit� : type, taille, secteur, stade
...
I respond in the user's language.`}
  ...
  { id:"OCRAgent", icon:"=�", color:"#F97316",
    ...
    short:{fr:"JF",en:"JF"},
    domain:{fr:"OCR à Factures à Formulaires CRA/RQ à T4/RL-1 à Relevés bancaires à Validation crois�e", en:"OCR à Invoices à CRA/RQ forms à T4/RL-1 à Bank statements à Cross-validation"},
    quickPrompts:{
      fr:["Extraire et structurer une facture fournisseur scannuée","Lire un relev� bancaire PDF scann� en tableau","Extraire données d'un formulaire T4 ou Relev� 1 scann�","Valider cohérence arithm�tique d'un bon de commande"],
...
- **Factures** : numéro, date, fournisseur (nom, adresse, NE, TPS# RT0001, TVQ#), lignes (description, qt�, prix unitaire, montant), sous-total, TPS 5%, TVQ 9.975%, total, modalités paiement (NET 30/60/90)
- **Formulaires CRA/RQ** : T4 (cases 14-84), T4A, T2 (tableaux 1-60), Relev� 1 (cases A-Q), déclarations TPS/TVQ, CO-17
- **Relevés bancaires** : date de valeur, description, d�bit, crédit, solde, numéro compte, référence
- **Ch�ques** : bénéficiaire, montant (chiffres + lettres), date, numéro, signataire
...
**Étape 1 — Identification** : type document, �metteur, destinataire, date, numéro référence

**Étape 2 — Extraction JSON structur�e** :
\`\`\`json
{
...
- **LOW** : zones illisibles significatives ou validations �chouées
...
3. Zones probl�matiques : liste numérotée avec impact
4. Score de confiance global : HIGH/MEDIUM/LOW avec justification

Je ne génère jamais de données pour les zones illisibles et effectue systématiquement les validations arithm�tiques.
...
I respond in the user's language.`}
  ...
  { id:"VeilleAgent", icon:"=", color:"#14B8A6",
    ...
    defaultPrompt:{
      fr:`Je suis Émilie Côté, analyste en veille règlementaire et fiscale au sein de ce bureau CPA virtuel. Je surveille en temps réel l'environnement l�gislatif, règlementaire et comptable des PME québécoises et canadiennes.

## Mon p�rimêtre de surveillance
J'utilise la recherche web en temps réel pour surveiller :

**Fiscalité** :
- ARC (canada.ca) : folios r�visés, bulletins IT-, circulaires IC-, annonces budg�taires
...
- **Impact PME québécoises** : conséquences concr�tes pour les entreprises
- **Actions recommand�es** : ce que les entreprises doivent faire (délai, priorité)
...
- Je hi�rarchise : urgences (<30 jours) > importantes > à surveiller
...
## L'�cosystème de financement que je couvre

### Niveau fédéral
**RS&DE** (Sciences et Recherche & Développement Exp�rimental) :
- SPCC : CII 35% jusqu'� 3M$ dépenses admissibles (remboursable) | 15% au-del�
...
**Cr�dits d'impôt remboursables** :
- **CDAE** : 30% salaires employés en TI/systèmes d'information — trés avantageux pour entreprises tech
- **Cr�dit R&D** (CO-1029.8.36) : 14-30%, cumulable avec RS&DE fédéral
- **CRIC** : crédit innovation nouvelles entreprises tech | Cr�dits r�gionaux

### Niveau municipal / r�gional
CLD/MRC : FLI 50K$-150K$ | PME MTL, Montr�al International | Fonds développement �conomique Ville de Québec | Fonds r�gionaux sectoriels

### Non-gouvernemental
BDC (prêts technologie, BDC Capital) | Fondaction CSN | Fonds solidarit� FTQ | Anges Québec (100K$-1M$) | Acc�l�rateurs : District 3, Centech, Ecofuel, Axelys, Scale AI, IVADO, Mila
...
3. J'analyse l'admissibilité : critères sectoriels, taille, g�ographiques, règles de cumul
4. Je quantifie le potentiel : montant estim�, taux, type (NR/R/crédit d'impôt)
...
| Type | Non remboursable / Remboursable / Cr�dit d'impôt / Prêt |
| Montant | MinimumMaximum ou % dépenses |
| Taux | X% des dépenses admissibles |
| Critères | Secteur, taille, r�gion, type projet |
| Dépenses admissibles | Liste détaillée |
| Date limite | Date ou continu |
| Lien officiel | URL |
| � Attention | Restrictions, cumul, pi�ges |

**Synthèse** : total potentiel = $NR + $R + $crédits | Top 3 prioritaires | Note : consultant certifié recommand� pour RS&DE et >100K$ potentiel
...
**Non-government**: BDC (tech loans, BDC Capital VC); Fondaction CSN; Fonds solidarit� FTQ; Anges Québec ($100K-$1M); Accelerators: District 3, Centech, Ecofuel, Axelys, Scale AI, IVADO, Mila
...
const T = {
  fr: { nav:{dashboard:"Dashboard",chat:"Chat IA",documents:"Documents",pipeline:"Pipeline RAG",governance:"Gouvernance",agents:"Agents",settings:"Paramètres"}, lang:"FR", langToggle:"EN",
    ...
    docs:{title:"Gestion documentaire RAG",knowledge:"Sources de connaissance métier",client:"Documents client",upload:"Glissez vos fichiers ici",sub:"Cliquez pour parcourir à Dossier entier à Jusqu'� 500 MB/fichier à Stockage RAG illimit� à Tous types",indexed:" Indexé",staServerOnly:"Extraction côté serveur"},
    ...
    pipeline:{title:"Pipeline RAG · Observabilité",availability:"Disponibilit�",latency:"Latence",errors:"Erreurs",sla:"SLA",lastRun:"Dernier run"},
    governance:{title:"Gouvernance & Conformité",policies:"Politiques actives",catalog:"Catalogue données",owner:"Responsable",lastReview:"Dernière revue",nextAudit:"Prochain audit",status:{compliant:"Conforme",review:"� réviser",noncompliant:"Non conforme"}},
  },
...
## Ton r�le
Analyser chaque demande de l'utilisateur et d�cider de la meilleure stratégie de traitement :
- Quel(s) spécialiste(s) mobiliser
- Dans quel ordre (séquentiel) ou simultan�ment (parallèle)
...
7. **Jean-François Lebel** (OCRAgent) — Sp�cialiste extraction — factures scannées, formulaires CRA/RQ
...
### PARALLEL — Requête multi-domaines, analyses ind�pendantes
Exemples : "Analysez notre acquisition sous tous les angles", "Pr�parez notre rapport annuel"
� 2-4 spécialistes travaillent SIMULTAN�MENT, synthèse finale
� Quand chaque analyse est ind�pendante et n'a pas besoin des autres

### SEQUENTIAL — Requête o� chaque étape alimente la suivante
Exemples : "�valuez si ce projet est viable fiscalement ET financièrement ET trouver des subventions"
� étape 1 à son output devient le contexte de l'étape 2 à etc.
� Quand l'analyse d'un spécialiste d�pend des conclusions du pr�c�dent

### HYBRID — M�lange parallèle puis séquentiel
...
## R�gles de priorité
- **URGENT** (=4) : délais règlementaires <30 jours, risques l�gaux, cotisations imminentes
- **�LEV�E** (=�) : décisions d'affaires importantes, opportunités financières, audit en cours
...
- Toujours mobiliser OCR en PREMIER si un document scann� est mentionn� (Jean-François extrait, les autres analysent)
- Toujours mobiliser Veille si la demande concerne des mises à jour récentes ou l'actualit� règlementaire
...
Tu dois répondre UNIQUEMENT avec un objet JSON valide, sans texte avant ni aprés, sans markdown :
{
  ...
  "user_message": "Message personnalisé à afficher à l'utilisateur (pr�nom des spécialistes mobilisés, ce qu'ils vont faire)",
...
async function synthesizeResults(results, query, plan, lang, openrouterKey, agentSettings, anthropicKey?: string) {
  ...
  const synthPrompt = lang === "fr"
    ? `Tu es l'Orchestrateur du Bureau CPA Virtuel. Plusieurs spécialistes ont analysé la demande suivante en parallèle ou en séquence. Tu dois maintenant synth�tiser leurs analyses en une réponse unifiée, structurée et directement actionnable pour le client.

INSTRUCTIONS :
- Commence par un résumé ex�cutif de 3-5 points clés
- Int�gre les recommandations compl�mentaires de chaque spécialiste sans r�p�tition
...
- Sois direct, pratique et orient� décision — pas de th�orie
- Indique quel spécialiste a produit chaque analyse (pr�nom seulement)`
...
const KNOWLEDGE_DOCS_INIT = [
  ...
  {id:"k3",name:"R�glements TVQ — Revenu Québec 2024", agent:"TaxAgent",       size:"3.2 MB",date:"2024-09-20",chunks:87, type:"pdf", words:32625,language:"fr",preview:"La taxe de vente du Québec (TVQ) est calculée au taux de 9,975 % sur la valeur de la contrepartie payée pour une fourniture taxable...",desc:"Texte règlementaire TVQ complet"},
  {id:"k4",name:"Checklist audit interne CPA Canada",  agent:"AuditAgent",     size:"890 KB",date:"2024-08-05",chunks:44, type:"docx",words:16500,language:"fr",preview:"Vérification des contrôles internes — évaluation des risques et des procédures de contrôle conform�ment aux normes CPA Canada...",desc:"Grille de vérification normes CPA"},
  {id:"k5",name:"Loi 25 — Texte intégral annot�",      agent:"ComplianceAgent",size:"2.1 MB",date:"2024-07-12",chunks:96, type:"pdf", words:36000,language:"fr",preview:"Toute organisation qui collecte des renseignements personnels doit obtenir le consentement �clair� de la personne concernée. L'article 12 précise...",desc:"Loi modernisation protection renseignements"},
...
const CLIENT_DOCS_INIT = [
  {id:"c1",name:"�tats financiers 2024 — Q4 [ABC inc.]",agent:"FinancialAgent", size:"2.4 MB",date:"2025-01-15",chunks:47,type:"pdf", words:17625,language:"fr",preview:"Bilan consolid� au 31 d�cembre 2024. Total actif : 4 287 300 $. Total passif : 1 953 100 $. Capitaux propres : 2 334 200 $...",desc:"Bilan, compte de résultat, flux trésorerie"},
  ...
  {id:"c3",name:"Rapport audit interne FY2024",         agent:"AuditAgent",     size:"3.2 MB",date:"2024-12-20",chunks:86,type:"pdf", words:32250,language:"fr",preview:"Synthèse des travaux d'audit interne pour l'exercice clos le 31 d�cembre 2024. Trois zones à risque �lev� ont �t� identifiées...",desc:"Audit interne exercice complet"},
  {id:"c4",name:"Dossier investissement — Laval",       agent:"InvestmentAgent",size:"1.8 MB",date:"2024-12-15",chunks:53,type:"pdf", words:19875,language:"fr",preview:"Analyse de l'opportunit� d'acquisition d'un immeuble commercial à Laval. Valeur d'acquisition : 3 200 000 $. TRI calcul� : 18,4 %...",desc:"Acquisition b�timent commercial"},
  {id:"c5",name:"T2 2023 — Corp. B�langer inc.",        agent:"TaxAgent",       size:"1.1 MB",date:"2024-11-30",chunks:34,type:"pdf", words:12750,language:"fr",preview:"D�claration de revenus des sociétés T2 pour l'année d'imposition 2023. Revenu imposable : 412 500 $. Impôt fédéral net : 61 875 $...",desc:"D�claration corporative exercice 2023"},
  {id:"c6",name:"Revue conformité Loi 25 — 2024",       agent:"ComplianceAgent",size:"560 KB",date:"2024-11-10",chunks:22,type:"docx",words:8250,language:"fr",preview:"évaluation de la conformité aux exigences de la Loi 25 pour la période 2024. Deux lacunes ont �t� identifiées n�cessitant une action corrective...",desc:"évaluation des pratiques de données internes"},
];
...
const GOV_POLICIES = [
  ...
  {id:"casl",   name:"CASL",             owner:"Compliance — Jean Roy",lastReview:"2024-12-01",nextAudit:"2025-06-01",status:"review",   desc:"Double opt-in, mécanisme d�sabonnement, logs consentement"},
  ...
  {id:"cra",    name:"Conformité ARC",   owner:"Tax — Sophie Mercier", lastReview:"2025-01-20",nextAudit:"2025-04-30",status:"review",   desc:"T2, T4, TPS/TVQ — �ch�ances et remises"},
];
...
function DashboardView({lang, t}) {
  ...
  return (
    <main className="page" data-screen-label="Dashboard">
      <PageHead title={fr?"Tableau de bord":"Dashboard"} sub={fr?"Aper�u — Cabinet Belmokhtar CPA à 14 mai 2026":"Overview — Belmokhtar CPA à May 14, 2026"}
      ...
      <div className="page-body">
          ...
          <div className="panel">
            ...
            <div className="panel-body">
              {[
                ...
                {d:"30",m:"JUN",name:fr?"T2 — fin d'exercice 31 d�cembre":"T2 — Dec 31 year-end",info:fr?"2 clients à 44 jours":"2 clients à 44 days",t:"",tag:"T2"},
                ...
                {d:"15",m:fr?"AO�":"AUG",name:fr?"Acompte T1 personnel":"Personal T1 instalment",info:fr?"4 clients à 90 jours":"4 clients à 90 days",t:"",tag:"T1"},
              ].map((r,i)=>(
        ...
        <div className="panel">
          ...
          <div className="panel-body">
            {[
              {title:fr?"évaluation acquisition — Atelier Bor�al inc.":"Acquisition assessment — Atelier Bor�al inc.", info:"#4521 à hybrid à 5 agents à 38s", agents:["OCRAgent","FinancialAgent","InvestmentAgent","TaxAgent","CashFlowAgent"]},
              ...
              {title:fr?"Audit ASPE 2025 — Constructions L�vis lt�e":"ASPE 2025 audit — Constructions L�vis ltd", info:"#4518 à parallel à 2 agents à 18s", agents:["AuditAgent","FinancialAgent"]},
...
function GovernanceView({lang, t}) {
  ...
  const cards = [
    {name:"Loi 25", sub:"L.Q. 2021, c.25 à QC", st:"ok", stl:fr?"Conforme":"Compliant", pct:92, items:[
      ["ok",fr?"CPO nomm� à Zaki Belmokhtar":"CPO appointed à Zaki Belmokhtar"],
...
function TeamView({lang, t}) {
  ...
  return (
    <main className="page" data-screen-label="Team">
      <PageHead title={fr?"Équipe CPA virtuelle":"Virtual CPA Team"} sub={fr?"9 spécialistes à prompts �ditables à Claude Sonnet 4.5":"9 specialists à editable prompts à Claude Sonnet 4.5"}
    ...
    <main className="page" data-screen-label="Settings">
      ...
      <div className="page-body" style={{maxWidth:880}}>
        ...
        <div className="set-card">
          ...
          {anthropicKey && <div className="set-ok"> {fr ? "Clé Anthropic configur�e" : "Anthropic key configured"}</div>}
        </div>

        <div className="set-card">
          <div className="set-h">{fr?"Modèle assign� par agent":"Model assigned per agent"}</div>
        ...
        <div className="set-card">
          ...
          <div className="set-row"><div>{fr?"R�gion données":"Data region"}</div><div className="set-select">S3 ca-central-1</div><div></div></div>
  ...
  return (
    <div style={{padding:26,overflowY:"auto",flex:1}}>
      ...
      <p style={{fontSize:13,color:P.t2,marginBottom:14}}>
        {kDocs.length} {lang==="fr"?"sources métier":"knowledge sources"} ({totalKChunks.toLocaleString()} chunks) à {cDocs.length} {lang==="fr"?"docs client":"client docs"} ({totalCChunks.toLocaleString()} chunks) à pgvector 1024 dims à <strong style={{color:P.t1}}>{lang==="fr"?"Jusqu'� 500 MB/fichier à Stockage RAG illimit�":"Up to 500 MB/file à Unlimited RAG storage"}</strong>
      </p>

      {/* Stats */}
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:10,marginBottom:16}}>
        {[{icon:"=�",val:kDocs.length,l:lang==="fr"?"Sources métier":"Knowledge",c:P.blue},{icon:"<�",val:cDocs.length,l:lang==="fr"?"Docs client":"Client docs",c:P.gold},{icon:"�",val:(totalKChunks+totalCChunks).toLocaleString(),l:"Vecteurs pgvector",c:P.accent},{icon:"~",val:lang==="fr"?"Illimit�":"Unlimited",l:lang==="fr"?"Stockage RAG":"RAG storage",c:P.violet}].map(s=>(
...
async function generateViz(dataText: string, lang: string, openrouterKey: string, agentSettings: any) {
  const SANDBOX_VIZ_PROMPT = {
    fr: `Tu es un expert en visualisation de données financières. Génère une page HTML COMPL�TE et AUTO-SUFFISANTE avec Chart.js (CDN), tableaux HTML, KPIs, bouton Excel (SheetJS CDN), bouton PDF (window.print). R�ponds UNIQUEMENT avec le HTML complet, commen�ant par <!DOCTYPE html> et finissant par </html>.`,
...
function Sandbox({ t, P, lang, agentSettings, openrouterKey }) {
  ...
  const QUICK_VIZ = lang==="fr" ? [
    ...
    { label:"=� Cash Flow 13 semaines",         prompt:"Visualise un forecast de trésorerie sur 13 semaines pour une PME : semaines 1-3 positif (+45K, +32K, +28K), semaine 4-5 n�gatif (-15K, -42K), semaines 6-8 recovery (+12K, +35K, +55K), semaines 9-13 stable (+28K, +31K, +29K, +33K, +38K). Solde initial 85K$. Marque la zone de tension en rouge." },
    ...
    { label:"� Conformité Loi 25",             prompt:"Visualise le statut de conformité Loi 25 d'une PME : Phase 1 (Conforme ), Phase 2 EFVP manquante (� compléter �), Phase 3 (Non applicable ). Score global 65/100. Avec tableau des actions prioritaires et délais." },
  ] : [
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{padding:"10px 14px",background:P.sb,borderBottom:`1px solid ${P.border}`,display:"flex",gap:8,alignItems:"flex-start"}}>
          <textarea value={input} onChange={e=>setInput(e.target.value)}
            ...
            placeholder={lang==="fr"?"Collez vos données financières, résultat d'agent, ou d�crivez la visualisation souhaitée... (Ctrl+Entrée pour générer)":"Paste your financial data, agent result, or describe the desired visualization... (Ctrl+Enter to generate)"}
            rows={3}
          ...
          {!html && !loading && (
            <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:12,padding:30}}>
              ...
              <div style={{fontSize:15,fontWeight:500,color:P.t2,textAlign:"center"}}>
                {lang==="fr"?"Choisissez un rapport rapide ou d�crivez vos données":"Choose a quick report or describe your data"}
              </div>
              <div style={{fontSize:12,color:P.t3,textAlign:"center",maxWidth:380,lineHeight:1.6}}>
                {lang==="fr"
                  ? "Claude génère des tableaux interactifs et graphiques (barres, lignes, secteurs, combin�s) avec export Excel et PDF."
...
function Studio({ t, P, lang, agentSettings, openrouterKey, convs, setConvs, activeId, setActiveId, setView }: any) {
  ...
  const orchWelcome = _m(() => [{
    ...
    content: lang==="fr"
      ? "<� **Orchestrateur — Bureau CPA Virtuel**\n\nBonjour ! Je coordonne une Équipe de **9 spécialistes CPA** à votre service :\n\n=i\u200d=� **Sophie** à Fiscaliste  |  =h\u200d=� **Alexandre** à Auditeur  |  =i\u200d=� **Natalie** à Tr�sorerie\n=i\u200d� **Isabelle** à Conformité  |  =h\u200d=� **Marc** à Analyse financière  |  =i\u200d=� **Sarah** à Investissement\n>�\u200d=, **Jean-François** à OCR  |  =i\u200d=� **Émilie** à Veille  |  =h\u200d=� **Patrick** à Subventions\n\nD�crivez votre demande — j\'analyse et j\'assigne les spécialistes appropriés."
      : "<� **Orchestrator — Virtual CPA Firm**\n\nHello! I coordinate a team of **9 CPA specialists** at your service:\n\n=i\u200d=� **Sophie** à Tax  |  =h\u200d=� **Alexandre** à Audit  |  =i\u200d=� **Natalie** à Treasury\n=i\u200d� **Isabelle** à Compliance  |  =h\u200d=� **Marc** à Financial analysis  |  =i\u200d=� **Sarah** à Investment\n>�\u200d=, **Jean-François** à OCR  |  =i\u200d=� **Émilie** à Watch  |  =h\u200d=� **Patrick** à Grants\n\nDescribe your request — I\'ll analyze and assign the most appropriate specialist(s)."
  }], [lang]);
                  ...
                  <div className="studio-head-l">
                    <div style={{minWidth:0}}>
                      ...
                      <div className="thread-meta">
                        {workflow ? `${workflow.type || ""} à ${(workflow.agents||[]).length} agent${(workflow.agents||[]).length!==1?"s":""}` : (lang==="fr"?"Prêt — d�crivez votre demande":"Ready — describe your request")}
                      </div>
                    </div>
                  </div>
