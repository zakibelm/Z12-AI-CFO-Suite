...
COST_PER_1K_TOKENS_IN = {
    "deepseek/deepseek-v4-pro": 0.003,
...
COST_PER_1K_TOKENS_OUT = {
    "deepseek/deepseek-v4-pro": 0.015,
...
async def execute_page_with_evv(
    ...
    for execute_retry in range(MAX_EXECUTE_RETRIES + 1):
        ...
        if execute_retry == 1:
            model_used = "deepseek/deepseek-v4-pro"  # niveau 2
        elif execute_retry == 2:
            model_used = "deepseek/deepseek-v4-pro"  # niveau 3 avec prompt renforcé
